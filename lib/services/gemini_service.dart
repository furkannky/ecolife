...
class GeminiService {
 ...
 static const String _endpoint =
  ...
  static Future<String> tarifOner(List<String> malzemeler) async {
    final prompt =
        "Elimde şu malzemeler var: ${malzemeler.join(", ")}. Bu malzemelerle hangi yemek tariflerini yapabilirim? Detaylı olarak 1-2 öneri ver. ve önerilerinde karbon ayak izine de öenm ver.";
